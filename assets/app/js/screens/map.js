// Project Curse 6 — map. Legacy-compatible local stores; no legacy runtime imports.
...
function operationTerrain(operation){
  ...
  function bind(){
    ...
    root.document.addEventListener('projectcurse:pilgrimage-state-change',V.onPilgrimageChange,options);
