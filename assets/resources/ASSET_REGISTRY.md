...
`responsive/` contains 48 WebP delivery copies generated from 24 high-cost PNG or JPEG files. Each source has a 480px candidate and either a 960px candidate or a no-upscale candidate at its native width. The 2026-08-28 additions include 480px and 960px delivery copies for the Northern Front, North Sea blockade, and Dead Zone silent-interior reconstructions; the preserved PNGs remain the sources used for full inspection.
