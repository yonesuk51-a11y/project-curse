// Project Curse 5.40.0 — terminal hub manifest and runtime ownership map
(function(root){
  'use strict';
  ...
  root.ProjectCurseStructure=freeze({
    version:root.ProjectCurseBuild?.version||'5.40.0',
    schema:root.ProjectCurseBuild?.schema||'project-curse-v33',
