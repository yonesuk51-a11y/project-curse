...
(function(root){
  ...
  const chapters=[
    ...
    {index:'05',range:'남방 작전',title:'남방 전쟁이 모이다',summary:'분열된 교단과 특수부대, 집단 소환 계획이 하나의 쿠데타 작전으로 수렴한다.',ids:['Operation_Broken_Crown']}
  ];
  const operation={
  ...
  "indexIntro": "처음에는 한 사건처럼 보였던 기록들이 시간이 지나며 같은 붕괴의 일부로 이어졌다. 위에서 아래로 읽으면 금지 기술의 실험부터 남방 전쟁까지의 흐름을 따라갈 수 있다.",
