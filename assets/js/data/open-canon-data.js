...
(function (root) {
  ...
  root.ProjectCurseOpenCanon = freeze({
    ...
    faction: {
      ...
      ushinoda: ['교단 도상 속 소녀의 모습이 우시노다의 실제 모습인가?', '곁에 무릎 꿇은 검은 날개의 기사는 누구인가?', '교단 명단의 하나뿐인 번호는 세 파벌의 로드좌·사도석과 어떻게 맞물리는가?'],
    ...
    guide: [
      ...
      { title: '우시노다교 사도 번호', text: '지금의 제1~제9사도는 2042년 교단 명단을 따른다. 이 번호가 세 파벌의 사도석과 어떻게 맞물리는지, 우시노다에게 맞섰던 기사 히라에스가 제3사도가 된 경위는 정하지 않았다.', route: ['faction-info', 'ushinoda'] },
