  ...
  root.ProjectCurseArchive=freeze({
    ...
    publicRecords:[
      ...
      },
      {
        ...
        title:'불멸을 향해',
        summary:'피의 호수 작전 파일. 회수된 현장 통신과 촬영 기록으로 구성됐다.'
      },
      {
        ...
        title:'괴이',
        summary:'Ferals·Superiors·Unusuals 계열의 통합 분류 기록. 확인 개체 15종의 특징을 정리했다.'
      },
      {
        ...
        title:'구역 위험도 분류 문서',
        summary:'그린·옐로우·레드·화이트·블랙존의 기본 판정 문서. 각 구역의 의미와 전환 조건을 정리했다.'
      },
      {
        ...
        title:'사쿠마의 테이프',
        summary:'도쿄 지부 조사관 사쿠마 유타의 사건 기록. 마지막 조사와 실종 경위를 묶었다.'
      },
      {
        ...
        title:'아마리온 회수 영상 기록',
        summary:'기업 교육 영상 회수본. 저근접 자기 왜곡 시스템과 공간 개척 사업을 소개한다.'
      },
      {
      ...
      },
      {
        ...
        tags:['레드울프','이탈','CCTV'],
        title:'레드울프 이탈 기록',
        summary:'이탈 직전의 암호화 CCTV 기록. 웨이드 밀렌과 제임스 애셔의 대화가 담겨 있다.'
      },
      {
        ...
        summary:'웨이드 밀렌·윌리엄 카터의 감청 음성. 축복으로 위장한 병기 계획을 논의한다.'
      },
      {
        ...
        title:'대흑림 권역 보고서',
        summary:'대흑림의 불완전한 지역 기록. 정착지와 성채, 교단 사이의 관계, 타락 야생체의 생태를 정리했다.'
      },
      {
      ...
      },
      {
        ...
        summary:'남방 집단 소환 차단 중의 대리 지휘 정보 기록. 처형 명령의 진위를 판별한다.'
      },
      {
        ...
        tags:['민간','대피 훈련','아동'],
        title:'아이들의 대피 수업',
        summary:'아이들의 학교 훈련 교재. 경보색, 창문 봉인, 가족 기억 대조문과 대피번호를 가르친다.'
      },
      {
