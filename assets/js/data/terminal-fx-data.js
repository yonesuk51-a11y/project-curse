  ...
  root.ProjectCurseTerminalFx = freeze({
    ...
    boot: {
      ...
      gate: {
        ...
        // 열람자 호출부호(2026-09-25 사용자 결정) — 비워 두면 익명으로 연다. 설정 창에서 언제든 바꾼다
        operator: {
          label: '열람자 호출부호',
          placeholder: '비워 두면 익명 열람',
          hint: '자캐 이름이나 호출부호를 적으면 단말이 그 이름으로 열립니다. 이 기기에만 저장됩니다.'
        }
      },
      // 기동 줄 가운데 ACCESS 줄 끝에 붙는 열람자 표시(기동·공유 주소 접속·세션 복원)
      operatorAccess: '열람자',
      cold: {
        kicker: 'U.A.C 합동작전 단말 / PC-03',
        title: '로컬 단말기 기동',
