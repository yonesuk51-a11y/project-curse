...
(function(root){
  ...
  const records={
    'deep-first-breach':{
      ...
      fragments:[
        {label:'대조표 01',kind:'analysis',text:'대흑림 성채 서판은 검은 강을 건너지 말라고 적는다. 데드존 지하문은 돌아온 자의 이름을 세 번 확인하라고 적는다. 유라시아 봉인문은 문밖에서 들린 목소리에 답하지 말라고 적는다. 세 기록이 같은 사건을 가리킨다는 증거는 없다.'},
        {label:'편찬자 메모',kind:'annotation',text:'최초 균열은 사건명이 아니라 묶음표시다. 한 시대의 재난으로 단정하면 서로 다른 장소의 금기를 억지로 하나의 기원에 종속시킨다.'}
      ]
    },
    ...
    'deep-outer-god-war':{
      documentType:'interview',author:'우시노다를 주군으로 부르는 화자 (신원 미상)',recipient:'수신자 없음 — 독백형 구술',purpose:'잊히지 않는 적의 이름 히라에스에 대한 회상',
      fragments:[
        {label:'화자의 회상 01',kind:'quote',text:'“그 시절에는 아직 괴이라는 이름조차 없었다. 별 너머에서 내려온 외신, 우시노다께서 처음 대지에 발을 디디던 시대였다.”'},
        {label:'화자의 회상 02',kind:'quote',text:'“죽음마저 다스리는 힘 앞에서 수많은 도시와 나라가 무너졌다. 그분의 군세는 끝없이 불어났고, 그분이 닿은 땅은 곧 새로운 성지가 되었다.”'},
        {label:'화자의 회상 03',kind:'quote',text:'“그 와중에도 끝까지 검을 내려놓지 않은 인간들이 있었다. 평범한 자들도, 특별한 힘을 지닌 자들도 있었다. 히라에스도 그 가운데 한 명이었다. 고향에 아내와 어린 아들이 있었다고 들었다.”'},
        {label:'화자의 회상 04',kind:'quote',text:'“그 전쟁에서 우리는 패배했다. 하지만 완전히 사라진 것은 아니었다. 남겨진 조각들이 긴 세월을 견디며 다시 우리를 이 땅으로 불러냈다.”'},
        {label:'편찬자 주석',kind:'document',text:'화자는 히라에스를 사라진 가족을 그리워한 전사로 기억한다. 인물 기록의 커네빈은 이신에 맞서 성벽에 섰던 기사로, 지금은 히라에스라는 이름으로 불린다. 히라에스는 돌아갈 수 없는 고향을 향한 그리움을 뜻하는 웨일스어다.'}
      ]
    },
    'deep-angel-descent':{
      documentType:'interview',author:'천사의 내장 낭송자 (이름을 남기지 않음)',recipient:'입문을 앞둔 자',purpose:'입문 전 경전 전수',
      fragments:[
        {label:'제1장 강림 1~4절',kind:'quote',text:'해가 아직 사람의 머리 위에 머물던 때에, 사람들이 땅에 원을 긋고 하늘을 불렀더라. 하늘이 붉게 찢어지매, 날개 가진 것들이 수천으로 내려왔더라. 날개 아래는 밤보다 어두웠으니, 그 어둠이 군대를 덮으매 창을 든 자와 무릎 꿇은 자가 함께 녹아 없어졌더라. 해가 그 광경을 차마 보지 못하고 눈을 감았더라.'},
        {label:'제1장 강림 5~10절',kind:'quote',text:'모든 자가 얼굴을 가리고 엎드렸으나, 오직 한 사람이 얼굴을 들었더라. 그는 눈을 감지 아니하였고, 녹지도 아니하였더라. 날개가 그를 삼켰다가 도로 내어놓으니, 그 등에 날개가 돋고 그 얼굴에 눈이 열렸더라. 열린 눈이 하나가 아니었으되, 그중 하나도 감기지 아니하였더라. 그가 손을 모으고 본 것을 고하매 손의 살이 떨어져 뼈만 남았으나, 끝내 그 손을 풀지 아니하였더라. 남은 자들이 그를 에폽테스라 불렀으니, 곧 본 자라.'},
        {label:'제2장 계명',kind:'quote',text:'너희는 눈을 감지 말라. 감은 눈 위로 날개가 지나가느니라. 본 것을 입에 담지 말고 띠에 적어 몸에 두르라. 입은 잊으나 띠는 잊지 아니하느니라. 피로 맹세하지 말라. 한 번 삼켜졌던 자는 다른 것에 두 번 삼켜지지 아니하느니라. 날개 안에서 녹지 아니한 자는 천사의 내장이라 일컬을지니, 삼켜진 자리에서 살아 나온 까닭이라. 해를 부르지 말라. 해는 눈을 감은 자요, 본 자가 아니니라. 누가 너희에게 무엇을 보았느냐 묻거든, 본 자를 보았다 하고 그 밖의 것은 말하지 말라. 너희 가운데 눈이 새로 열리는 자가 있거든 그를 ■■■■■ 하라.'},
        {label:'제3장 다시 오심 (1~3절 소실)',kind:'quote',text:'해가 다시 눈을 뜨는 날에 날개도 다시 내려오리니, 그날에 얼굴을 든 자는 본 자와 같이 되고, 얼굴을 가린 자는 녹으리라.'},
        {label:'편찬자 주석',kind:'document',text:'혈기사 다레버의 증언은 날개 달린 천사 수천이 군대를 삼키고 태양이 사라졌다고 적는다. 제1장의 장면과 겹친다. 천사의 내장은 혈맹의 공통 서약을 거부한 소규모 교단으로 기록돼 있고, 제2장은 피로 맹세하지 말라고 가르친다. 두 사실의 인과는 확인되지 않았다.'}
      ]
    },
    'deep-plague-copies':{
      documentType:'forensic',author:'유럽 고문서 합동감식실',recipient:'U.A.C 역사오염 심사관',purpose:'14세기 장부 여백의 봉인문과 후대 혈교 주장 분리',
      fragments:[
        {label:'재료 감식',kind:'finding',text:'세 사본은 서로 다른 지역과 시기에 제작됐다. 여백에 적힌 기억 대조 순서와 네 개의 혈점 기호는 일치한다. 본문은 당시의 세금·매장·배급 기록이다.'},
    ...
    '1975-09-12-amarion':{
      ...
      fragments:[
        {label:'설립 신고',kind:'document',text:'1975년 9월 12일, 아마리온은 법인 등록을 마쳤다. 신고된 사업은 인구 증가와 자원 부족에 대비한 공간 개척 연구였다. 저근접 자기 왜곡 시스템은 신규 공간에 대한 접근 수단으로 기재됐다. 그 공간에서 얻는 자원과 통행권은 회사 자산으로 처리됐다.'},
    ...
    '1975-distortion-system':{
      ...
      fragments:[
        {label:'대조 결과',kind:'analysis',text:'아마리온의 첫 가동일 이후 실종, 통신 장애와 생체 변질 신고가 늘어난 것은 맞다. 신고지는 서로 떨어져 있었다. 당시 수사기관은 산업재해, 가출과 종교 집회로 각각 종결했다. 같은 원인에서 나왔다는 물증은 남지 않았다.'},
    ...
    '1982-03-22-fhc':{
      ...
      fragments:[
        {label:'등록 내용',kind:'document',text:'1982년 3월 22일, F.H.C는 기술·연구 기업으로 등록됐다. 정부 계약서에는 아마리온 출신 연구진과 장비를 인수한다는 조항이 있다. 공간 연구라는 명칭은 사용되지 않았다.'},
        {label:'감사 메모',kind:'annotation',text:'설립 첫해 계약 가운데 일부는 연구 결과가 아니라 시설 접근권을 납품 대상으로 삼았다. 계약 담당자는 해당 조항을 표준 보안 조건으로 처리했다. 별도 검토를 요청하지 않았다.'}
      ]
    },
    '1982-uac-watch':{
    ...
    '1986-02-01-immortality':{
      ...
      counterRecord:{
        documentType:'contested',
        author:'혈교 계열 의례서기 / 계보 미확인',
        recipient:'다음 부름을 맡을 자',
        ...
        fragments:[
          {label:'부름 기입',kind:'log',text:'해가 물에 닿기 전 — 첫 부름\n두 번째 부름에 응답. 응답을 세는 자와 문을 지키는 자의 셈이 하나 어긋남\n물가에 표 두 개. 우리 것이 아니다. 손대지 않고 자리만 옮겨 두었다\n바깥에 불빛 여섯. 우리는 넷이었다\n세 번째 부름을 끝내지 못하고 물러남'},
          {label:'부름의 규칙',kind:'quote',text:'“물이 이름을 부르는 것은 응답이지 유인이 아니다. 응답을 받은 자를 데리고 나오지 않는다. 데리고 나오면 이름이 하나 남고 사람이 하나 사라진다.”'},
          {label:'회수 경위',kind:'annotation',text:'1991년 압수된 문서철에서 나온 문서다. 필사본이다. 원본은 회수되지 않았다. 작성 집단이 혈교의 어느 계보인지, 부름이 회수 작전보다 앞섰는지 뒤였는지는 확인되지 않았다. 같은 밤을 적은 현장 보고와 시각 표기 방식이 달랐다. 두 기록의 순서는 맞추지 못했다.'}
        ],
        limit:'두 기록은 표 두 개와 이름이 불렸다는 사실에서만 겹친다. 인원수, 불빛의 수와 부름의 횟수는 서로 맞지 않는다. 어느 쪽이 정확한지, 두 기록이 같은 시간대를 적은 것인지는 확정하지 않는다. 이 문서는 혈교가 사건을 일으켰다는 근거로도, 일으키지 않았다는 근거로도 등록하지 않는다.'
      }
    },
    '1989-08-23-tokyo':{
      documentType:'forensic',author:'U.A.C 도쿄 자료회수반',recipient:'교육기관 침투 조사팀',purpose:'F.H.C 도쿄 지부 교재와 피해 기록 대조',
      fragments:[
        {label:'회수물',kind:'finding',text:'학생용 교재에서 「Basic Of Blood Path」와 「Basic Of Flesh Path」가 발견됐다. 인쇄 형식은 일반 실습서와 같았다. 배포대장에는 생명공학 기초과목으로 등록돼 있었다.'},
    ...
    '1993-11-02-uac':{
      ...
      fragments:[
        {label:'창설 공고',kind:'document',text:'1993년 11월 2일, U.A.C는 공개 기관으로 전환됐다. 명칭에 국제연합을 사용하지만 UN 산하기관은 아니다. 협력국의 통행·정보 접근권과 자체 지휘망을 바탕으로 리버스 관련 국제 조정을 맡는다.'},
    ...
    '1993-syndicate':{
      ...
      fragments:[
        ...
        {label:'분석관 의견',kind:'annotation',text:'S.O.N을 교단의 하위조직으로 분류하면 자금 흐름을 설명할 수 없다. 이들은 필요할 때 교단과 거래했다. 같은 필요가 사라지면 공격했다. F.H.C가 시설과 운송로를 제공했다는 기록은 있다. 단일 지휘부의 존재는 입증되지 않았다.'}
      ]
    },
    ...
    '1997-01-27-classification':{
      ...
      fragments:[
        {label:'분류 고시',kind:'document',text:'공간·생체·정신 또는 혈성 변화가 연속적으로 발생하는 현상은 리버스(Rebirth)로 표기한다. 그 과정에서 출현하거나 인간 사회에 위장한 비인간 개체는 괴이(Feral)로 표기한다. 현상과 개체의 대응 절차는 별도로 작성한다.'},
    ...
    '1999-07-12-ubermensch':{
      ...
      fragments:[
        ...
        {label:'감사실 대조',kind:'analysis',text:'승인문에는 자발적 참여라는 표현이 없다. 실험 명부에서 수감자 외에 신원 불명자와 납치 신고 대상이 확인됐다. 포획한 그림자를 사람과 같은 격리실에 투입한 기록도 남아 있다.'},
    ...
    '2002-02-20-ground-forces':{
      ...
      fragments:[
        {label:'운용 결과',kind:'analysis',text:'협력국 부대는 N.H.C 탄약과 방어장비, S.I.D 현장정보를 같은 작전망에서 받았다. 외교 승인 대기 없이 초기 봉쇄에 들어갈 수 있었다. 장비 사용권과 민간인 통제권은 국가마다 달랐다.'},
    ...
    '2003-02-05-city-barrier':{
      ...
      fragments:[
        {label:'배치 목적',kind:'document',text:'C.A.P-17은 리버스 발생 구역의 확장을 늦춘다. C.I. 스캐너는 초기 이상 신호를 공안·군사기관에 전달한다. 두 장비는 현상을 예방하는 설비가 아니다. 민간 대피와 현장 봉쇄가 뒤따르지 않으면 단독 운용 효과를 보증하지 않는다.'},
        {label:'일본측 인터페이스',kind:'analysis',text:'C.I. 판정기는 제6계측계획의 독립시계 합의와 광반환 지문 형식을 입력 규격으로 받아들였다. 센서 본체, 경보 기준과 국제 전송망은 U.A.C 사업단이 새로 설계했다. 따라서 JID-87 장치의 개명판으로 분류하지 않는다.'},
    ...
    '2005-01-21-ash-crew':{
      ...
      fragments:[
        ...
        {label:'첫 임무 인계',kind:'field',text:'군사작전이 끝난 구역에는 시신, 회수하지 못한 장비와 대피 명단에서 빠진 사람이 남는다. 애시 크루의 임무는 승리 여부를 다시 판정하는 것이 아니다. 그 잔여물을 처리하고 살아 있는 사람을 찾는다.'}
      ]
    },
    '2005-09-01-red-wolf':{
      documentType:'review',author:'N.H.C 인사감찰실',recipient:'지휘위원회',purpose:'레드울프 부대 이탈 원인과 손실 보고',
      fragments:[
        {label:'발생',kind:'field',text:'웨이드 밀렌과 레드울프 잔여 인원은 작전 복귀 명령을 거부했다. S.O.N 접촉선으로 이동했다. 추격조는 교전하지 않았다. 현장 지휘관은 “누가 적인지 다시 확인할 시간이 필요했다”고 보고했다.'},
    ...
    '2006-08-20-ubermensch-raid':{
      ...
      fragments:[
        {label:'확인 사항',kind:'document',text:'S.O.N 전력과 레드울프 인원이 미국 지부에 진입했다. 방랑자 10명이 시설 밖으로 이동했다. 연구자료 일부가 반출됐다. 시설 보안영상은 진입 직전부터 같은 구간을 반복 재생했다.'},
    ...
    '2007-03-11-continuity-withdrawal':{
      ...
      fragments:[
        ...
        {label:'인계반 기입',kind:'log',text:'동부 목록은 도착했다. 서부 목록은 빈 양식만 수신됐다. 내륙 관제소는 마지막 교신에서 철수 차량의 번호를 물었다. 해당 차량은 배차 기록에 없다.'},
    ...
    '2008-09-06-dead-zone-designation':{
      ...
      fragments:[
        {label:'회람 44-DZ',kind:'document',text:'북미 내륙에 적용하던 일반 구조, 영토 회복과 행정구역별 지휘 절차를 중지한다. 무응답 내륙의 지도 표제는 NORTH AMERICAN DEAD ZONE으로 통일한다. 이 분류는 내부 경계의 확정이나 해안 영유권의 소멸을 뜻하지 않는다.'},
    ...
    '2012-11-19-great-black-forest-survey':{
      ...
      fragments:[
        ...
        {label:'관측소 조치',kind:'document',text:'고정 경계선 작성은 중단됐다. 지도 표제는 GREAT BLACK FOREST로 고정한다. 행정구역 대신 통과가 확인된 회랑, 불이 켜진 성채와 마지막 교신 지점을 표시한다. SOUTHERN DEAD ZONE은 구문서 인용에만 남긴다.'}
      ]
    },
    ...
    '2016-02-21-blood-cult-atlantic-schism':{
      documentType:'intercept',author:'S.I.D 대서양 감청실',recipient:'교단관계 분석과',purpose:'남방 혈맹과 데드존 지부의 결별 확인',
      fragments:[
        {label:'데드존 송신',kind:'quote',text:'“길을 묻는 자에게 피를 요구하지 않는다. 돌아오는 자의 이름은 검문소와 함께 지킨다. 남쪽의 명령은 이 회랑에서 효력이 없다.”'},
        {label:'남방 혈맹 응답',kind:'quote',text:'“표식과 사도의 이름을 반납하라. 문을 열어 둔 자는 문밖의 것과 같은 편이다.”'},
        {label:'분석관 주석',kind:'analysis',text:'양측은 같은 의식어를 사용했다. 이후 보급로와 인명 명부를 공유하지 않았다. 교리 분쟁만으로는 이 결별을 설명하기 어렵다. 데드존 지부는 검문소·중립 마을과의 교환 없이는 회랑을 유지할 수 없었다.'}
      ]
    },
    ...
    '2021-05-04-fhc-submassacres':{
      ...
      fragments:[
        ...
        {label:'감식반 의견',kind:'analysis',text:'생존 로그는 마지막 문장을 지지하지 않는다. 시설들은 서로를 공격했다. 중앙 통제 요청에는 답이 없었다. 우시노다 잔존망의 개입 흔적은 있다. 어느 시설도 전체 명령을 보낼 위치에 있지 않았다.'},
    ...
    '2024-03-17-ushinoda-fabrication':{
      ...
      fragments:[
        {label:'감식 소견',kind:'finding',text:'지도부 연설로 알려진 장면의 입 모양과 음성이 맞지 않는다. 배경 종소리에는 서로 다른 지역에서 채록된 두 음원이 겹쳐 있다. 화면 오른쪽 인물은 다른 필름에도 같은 자세로 나타난다.'},
    ...
    '2026-08-20-northern-reversal':{
      ...
      fragments:[
        ...
        {label:'기술 계보',kind:'finding',text:'공동지휘소는 1992년 분산 이관된 JID-87 기록 형식과 2003년형 C.I. 판정기를 함께 사용했다. 오래된 노드는 적 신호를 판독하지 못했다. 기준시계와 반환 지문은 남겼다. 새 판정기는 그 차이를 전선 전체에서 비교했다.'},
        {label:'전황 통보',kind:'document',text:'동맹군은 의식 거점과 보급 회랑을 탈환했다. 짐승의 길 주력은 세 번째 차단선 밖으로 물러났다. N.H.C는 국면 전환, 일본 지휘부는 제한적 승리로 각각 표기했다. 적 전력의 소멸은 확인하지 않았다.'},
        {label:'S.I.D 부속 의견',kind:'annotation',text:'후퇴 부대 일부가 남방권 통신 경로를 사용했다. 지원, 통행 허용 또는 탈취 가운데 어느 관계였는지는 감청만으로 구분되지 않는다.'}
      ]
    },
    '2027-11-02-southern-allegiance':{
      documentType:'intercept',author:'S.I.D 남방 해안 감청반',recipient:'OP-BROKEN-CROWN 사전분석실',purpose:'남방 교단·무장분파의 공동 지휘 여부 판단',
      fragments:[
        ...
        {label:'서약 거부 확인',kind:'document',text:'천사의 내장, 몬수르 교회 한 곳과 일부 성채권은 공통 암호를 사용하지 않았다. 이들은 혈맹에 선전포고하지 않고 피난권과 교역로의 중립을 통보했다.'},
        {label:'남은 공백',kind:'annotation',text:'우시노다 잔존 인원이 혈맹 지휘부에 들어갔다는 명단은 있다. 본인 확인이 되지 않았다. F.H.C 내부전에서 사망한 사람의 이름이 다시 사용됐을 가능성이 있다.'}
      ]
    },
    '2028-07-25-mass-summoning-rehearsal':{
      documentType:'forensic',author:'S.I.D 도시신호 분석실',recipient:'남방권 합동대응반',purpose:'동시 리버스의 작전 목적과 대응 지연 분석',
      fragments:[
        {label:'발생 기록',kind:'log',text:'도시 A  경계등급 2 / 자력 복구\n도시 B  피해규모 과장 신호 수신 / 예비대 출동\n도시 C  동일한 소환 앵커 잔류물 회수\n해안 감청소  출동시각을 묻는 암호통신 포착'},
        {label:'분석',kind:'analysis',text:'각 현상은 해당 도시 전력으로 봉쇄할 수 있었다. 과장된 구조 요청 때문에 예비대가 갈라졌다. 혈맹 특수부대 통신에는 출동과 차단망 재가동 시간이 기록됐다. 대응 절차를 측정한 예행이라는 판정은 이 통신에 근거한다.'},
        {label:'후속 조치',kind:'directive',text:'대규모 소환 앵커 반입 여부를 감시한다. 성위대 지휘부에서 발견된 혈맹 암호키는 사용자 신원 확인 전까지 침투 증거로 단정하지 않는다.'}
      ]
    },
    ...
    '2030-01-17-broken-crown':{
      documentType:'field',author:'OP-BROKEN-CROWN 합동상황실',recipient:'U.A.C 조정위원회·현장지휘관',purpose:'남방 동시 소환과 지휘부 침투 대응',
      fragments:[
        {label:'작전일지',kind:'log',text:'T-06:00  해안 분파 집결 확인\nT-04:20  소환 앵커가 두 도시와 성위대 보급선으로 분산\nT-02:10  성위대 지휘관 서명과 혈맹 암호키 일치\nT-00:40  도시권 동시 소환 전조\nT+00:18  해안 통신 두절'},
    ...
    '2031-02-03-branch-seal':{
      ...
      fragments:[
        ...
        {label:'봉인실 메모',kind:'quote',text:'“원본을 골라 달라는 요청은 네 번 왔다. 네 묶음에는 같은 인계번호가 찍혀 있었다. 하나를 고르는 순간 나머지 셋은 사고가 아니라 거짓말이 된다.”'},
        {label:'위원회 한계',kind:'annotation',text:'봉인번호가 중복된 원인은 남지 않았다. 기록 조작·통신 중첩·현장 단말 분기 저장을 조사 항목으로 유지한다. 이 목록 자체를 현실 분할의 증거로 인용하지 않는다.'}
      ]
    },
    '2032-08-14-three-bells-compact':{
      ...
      fragments:[
        ...
        {label:'회랑 안내인',kind:'quote',text:'“열두 성이 한자리에 모였다고요? 나는 그런 자리를 본 적 없습니다. 세 장을 날랐고, 셋 다 글씨가 달랐어요. 종 순서만 같았습니다. 세 번째 종을 들으면 길보다 표지석을 먼저 의심하십시오.”'},
        {label:'서기 주석',kind:'annotation',text:'열두 장부에서 같은 타종 순서가 확인된다. 최초 제안자와 합의 장소 칸은 모두 비어 있다. 안전 보증 조항은 없다.'}
      ]
    },
    '2034-04-22-inland-beacon-31':{
      documentType:'forensic',author:'S.I.D 데드존 신호감식반',recipient:'서부 해안 격리선·검문소 01–09',purpose:'폐쇄 항로표지기 응답열의 발신지 감식',
      fragments:[
        {label:'정비기록',kind:'log',text:'14:02:11  표지기 전원 인가\n14:02:19  내륙 반향 1 수신\n14:02:37  호출부호 31개 연속 응답\n14:03:53  응답열 반복 / 날짜 -1\n14:05:27  전원 물리 차단 후 6초간 수신 지속'},
        {label:'정비반 음성',kind:'quote',text:'“차단기는 내려갔습니다. 전원선도 제 손에 있었고요. 그런데 서른한 번째 호출이 끝난 뒤 첫 번째가 다시 대답했습니다. 이번에는 날짜가 어제였습니다.”'},
        {label:'파형 대조',kind:'finding',text:'호출부호 1–8은 2007년 이전 구조대 대장과 일치. 9–31은 등록 이력 없음. 반복마다 음성 내용은 같다. 경과 날짜만 하루씩 앞선다. 압축·접합 흔적은 검출되지 않았다.'},
        {label:'배포 제한',kind:'directive',text:'좌표는 순례 경로로 배포하지 않는다. 검문소 판정기는 파형 지문만 수신한다. 같은 응답을 포착해도 구조 승인으로 처리하지 않는다.'}
      ]
    },
    '2036-12-12-central-callsign-loss':{
      ...
      fragments:[
        ...
        {label:'잔존 송신',kind:'quote',text:'혈교망: “중앙의 밤은 끝났다. 날짜는 각자의 피로 센다.”\n그림자교망: “이름을 기다리지 마라. 먼저 도착한 그림자가 명령지다.”'},
        {label:'감청 판정',kind:'analysis',text:'공통 호출명으로 세 파벌의 동시 행동을 설명할 수 없게 됐다. 타락교 문구는 혈맹 보급명령과 F.H.C 잔존시설 경고문에 함께 남았다. 발신 지문은 서로 일치하지 않는다.'},
        {label:'계보 주의',kind:'annotation',text:'호출명 하나가 사라졌을 뿐이다. 우시노다교 전체 제거로 집계하지 말 것. 파벌·지역 교회·잔존 인원은 별도 계보에서 추적한다.'}
      ]
    },
    '2038-06-29-sixth-northern-line':{
      ...
      fragments:[
        ...
        {label:'신호장교 구두보고',kind:'quote',text:'“구조 요청의 내용은 듣지 않았습니다. 누가 우는지 들으면 예비대가 움직입니다. 우리는 목소리 대신 두 노드에 남은 반환 지문만 맞췄습니다.”'},
    ...
    '2042-10-31-three-night-silence':{
      documentType:'contested',author:'S.I.D 대륙간 신호합동실 / 성채·검문소 기록원',recipient:'U.A.C 연대기 편찬실',purpose:'대흑림·데드존 동시 무응답 기록 대조',
      fragments:[
        {label:'공통 시각표',kind:'log',text:'10.31 02:17  대흑림 성채 6곳 외부망 소실\n10.31 02:17  데드존 검문소 4곳 외부망 소실\n11.02 15:18  양측 연결 복구\n무응답  61시간 01분\n현지 방벽·조명  중단 보고 없음'},
        {label:'대흑림 장부',kind:'quote',text:'“둘째 밤, 서쪽 문이 검문소 07의 호출명을 세 번 울렸다. 우리 종에는 그런 글자를 새긴 적이 없다. 문은 열지 않았다.”'},
        {label:'검문소 자동기록',kind:'log',text:'15:19:08  미등록 호명 1 / 성채 장부 철자 일치\n15:19:14  미등록 호명 2 / 호흡 간격 일치\n15:19:21  발신 장치 검색 / 없음\n15:19:29  중계 경로 검색 / 없음'},
        {label:'합동실 유보',kind:'annotation',text:'동시 무응답과 교차 호명은 보존한다. 장거리 전송·시간 중첩·제3자 모방은 구분하지 못했다. 지도에는 관측점만 남긴다. 두 권역 사이 경로를 만들지 않는다.'}
      ]
    }
  };
  ...
  const recordLimits={
    ...
    '1982-uac-watch':'비인가 예산과 감시 인력의 흔적은 있다. 정식 창설 문서는 없다. 레스작 개인의 권능과 기억 개입은 증언 단계다.',
    '1986-02-01-immortality':'회수 순서와 현장 기록은 보존됐다. 호수의 기원과 실종 인원의 최종 상태는 확인되지 않았다.',
    ...
    '1993-syndicate':'공통 자금·운송망은 확인됐다. 단일 지휘부는 입증되지 않았다. 협력 관계를 교단 소속으로 확대하지 않는다.',
    '1995-03-20-tokyo-subway':'시설 침투와 인명 손실은 확정한다. 현장 개체의 종파와 명령 계통은 회수 영상만으로 판정할 수 없다.',
    '1997-01-27-classification':'분류 체계의 채택일을 기록한다. 등급은 대응 우선순위다. 존재의 기원이나 종을 확정하는 표가 아니다.',
    ...
    '2014-06-08-castle-asylum-right':'피난권을 인정한 사례는 남아 있다. 모든 성채에 적용되는 법은 아니다. 거부·대가·결투 조건은 별도 기록으로 본다.',
    '2016-02-21-blood-cult-atlantic-schism':'공개 결별과 상충 명령은 확인됐다. 문양과 의례의 공통점만으로 이전·현재 지휘권을 확정하지 않는다.',
    '2018-09-12-northern-front':'북부 전선의 확대와 일본 동맹권 배치는 확인됐다. 짐승의 길 전체 병력과 혈맹 지휘부의 의도는 추정치다.',
  ...
  const recordVisuals={
    ...
    '2016-02-21-blood-cult-atlantic-schism':{
      ...
      caption:'데드존 지부의 순례자 보호 노선과 혈맹 지휘부와의 결별을 통신선 분리로 표현했다. 결별의 실제 방식과 인물의 신원, 거점의 위치는 확정하지 않는다.'
    },
    '2027-11-02-southern-allegiance':{
      ...
      caption:'감청으로 추정된 혈맹 임시 충성망을 서로 거리를 둔 대표자들의 모임으로 표현했다. 서약의 실제 방식과 참석 분파, 모임의 장소는 확정하지 않는다.'
    },
    '2031-02-03-branch-seal':{
