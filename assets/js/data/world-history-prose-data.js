  ...
  const records={
    ...
    'deep-angel-descent':{
      ...
      fragments:[
        ...
        {label:'편찬자 주석',kind:'document',text:'혈기사 다레버의 증언은 날개 달린 천사 수천이 군대를 삼키고 태양이 사라졌다고 적는다. 제1장의 장면과 겹친다. 천사의 내장은 혈교의 공통 서약을 거부한 소규모 교단으로 기록돼 있고, 제2장은 피로 맹세하지 말라고 가르친다. 두 사실의 인과는 확인되지 않았다.'}
      ]
    },
    'deep-plague-copies':{
    ...
    '2027-11-02-southern-allegiance':{
      ...
      fragments:[
        ...
        {label:'남은 공백',kind:'annotation',text:'우시노다 잔존 인원이 혈교 지휘부에 들어갔다는 명단은 있다. 본인 확인이 되지 않았다. F.H.C 내부전에서 사망한 사람의 이름이 다시 사용됐을 가능성이 있다.'}
      ]
    },
