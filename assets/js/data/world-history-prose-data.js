...
(function(root){
  ...
  const records={
    ...
    '2008-09-06-dead-zone-designation':{
      ...
      fragments:[
        {label:'회람 44-DZ',kind:'document',text:'북미 내륙에 적용하던 일반 구조, 영토 회복과 행정구역별 지휘 절차를 중지한다. 내륙 무응답권의 지도 표제는 NORTH AMERICAN DEAD ZONE으로 통일한다. 이 분류는 내부 경계의 확정이나 해안 영유권의 소멸을 뜻하지 않는다.'},
    ...
    '2016-02-21-blood-cult-atlantic-schism':{
      documentType:'intercept',author:'S.I.D 대서양 감청실',recipient:'교단관계 분석과',purpose:'남부 혈교와 데드존 지부의 결별 확인',
      fragments:[
        {label:'데드존 송신',kind:'quote',text:'“길을 묻는 자에게 피를 요구하지 않는다. 돌아오는 자의 이름은 검문소와 함께 지킨다. 남쪽의 명령은 이 회랑에서 효력이 없다.”'},
        {label:'남부 혈교 응답',kind:'quote',text:'“표식과 사도의 이름을 반납하라. 문을 열어 둔 자는 문밖의 것과 같은 편이다.”'},
    ...
    '2028-07-25-mass-summoning-rehearsal':{
      ...
      fragments:[
        ...
        {label:'분석',kind:'analysis',text:'각 현상은 해당 도시 전력으로 봉쇄할 수 있었다. 과장된 구조 요청 때문에 예비대가 갈라졌다. 남부 특수부대 통신에는 출동과 차단망 재가동 시간이 기록됐다. 대응 절차를 측정한 예행이라는 판정은 이 통신에 근거한다.'},
    ...
    '2036-12-12-central-callsign-loss':{
      ...
      fragments:[
        ...
        {label:'감청 판정',kind:'analysis',text:'공통 호출명으로 세 파벌의 동시 행동을 설명할 수 없게 됐다. 타락교 문구는 남부 보급명령과 F.H.C 잔존시설 경고문에 함께 남았다. 발신 지문은 서로 일치하지 않는다.'},
  ...
  const recordLimits={
    ...
    '2018-09-12-northern-front':'북부 전선의 확대와 일본 동맹권 배치는 확인됐다. 짐승의 길 전체 병력과 남부 혈교 지휘부의 의도는 추정치다.',
