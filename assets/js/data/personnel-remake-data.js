...
(function(root){
  ...
  const records={
    'tanaka-chihiro':{name:'미나세 치히로',unit:'도쿄 민간기록 복원망',recordFunction:'민간인의 시점. 사건 뒤 지워진 주민 명부와 가족관계를 복구한다.',incident:'1989 도쿄 교육기관 실종자 명부 재구성'},
    'tanaka-yui':{name:'미나세 유이',unit:'수도권 재난통신 협동조합',recordFunction:'구조 명령과 검열 명령 사이에서 바뀌는 비상방송을 보여 주는 기술자.',incident:'1995 도쿄 지하철 비공개 개입 당시 중계기 수리'},
    ...
    'ryu-youngho':{name:'류영준',unit:'동북아 위험화물 철도망',recordFunction:'배차관. 봉인 화물과 피난 열차가 같은 선로를 공유한 현실을 드러낸다.',incident:'2006 소각시설행 표본차량의 우회 운행'},
    ...
    dennis:{name:'데니스 홀트',unit:'S.I.D 서부 귀환선 감각대조조',recordFunction:'가짜 감각 신호를 만드는 요원. 그 신호로 귀환자의 반응과 기생체의 반응을 분리한다.',incident:'2006 무응답 생존자 4명 대조',abilitySource:'위버멘시 감각더미 시술',abilityCost:'더미가 파괴될 때 본인의 통증·공포 기억으로 역류'},
    ...
    'apostle-jade-jackson':{name:'제이드 잭슨',unit:'우시노다 그림자석 주장자',role:'그림자석 주장자',recordFunction:'침투자. 조직을 죽이지 않고 내부 기억과 그림자를 갈라 장기 붕괴시킨다.',incident:'2005 S.I.D 그림자 자율행동 사건',abilitySource:'교단 계약 / 그림자 빙의',abilityCost:'침투한 정신마다 자신의 그림자가 독립 의지를 얻음'},
    'apostle-shahin':{name:'샤힌 아자르',unit:'우시노다 의지석 주장자',role:'의지석 주장자',recordFunction:'검사. 명령하지 않는다. 이미 가진 결심을 극단으로 밀어 자멸시킨다.',incident:'2006 북부전선 탈영·돌격 동시발생',abilitySource:'교단 계약 / 의지증폭',abilityCost:'타인의 결심을 증폭할수록 본인의 선택 능력이 일시 마비'},
