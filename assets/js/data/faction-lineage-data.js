...
(function(root){
  ...
  const nodes={
    ushinoda:{
      ...
      summary:'타락교·혈교·그림자교라는 세 종파를 공유 명칭 아래 묶는 교단 계통. 세 종파의 존재와 정원은 확정됐다. 모든 현장 명령이 하나의 중앙에서 나오는지는 확인되지 않았다.',
    ...
    'first-apostle':{
      ...
      summary:'교단 창설 이전부터 존재했다고 기록된다. 타락·혈액·그림자 세 권능을 모두 사용하는 유일 사도. 종파나 지역 지부로 분류하지 않는다.',
