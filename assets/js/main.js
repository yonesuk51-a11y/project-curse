(function(){
  ...
  if(boot){
    ...
    const lines=[
      '> TAPE DRIVE: MOTOR SPIN-UP...',
      '> U.A.C ARCHIVE NODE BOOTING...',
    ...
    // Browsers often block sound before a gesture. Try once, then unlock on first click/touch/key.
    startBootTape();
    const unlock=()=>{startBootTape(); if(cassetteStatus) cassetteStatus.textContent='TAPE FEED: ACTIVE';};
