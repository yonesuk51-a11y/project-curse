document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(pages.length){show((location.hash||'#terminal-home').slice(1));}
...
(function(){
  ...
  ready(function(){
    ...
    if(window.ProjectCurseStructure?.schema!=='project-curse-structure-v3') sideLinks().forEach(link=>{
...
(function(){
  ...
  ready(function(){
    ...
    const managedStructureV3=window.ProjectCurseStructure?.schema==='project-curse-structure-v3';
    ...
    if(!managedStructureV3 && sidebar && sidebar.dataset.pc5152ajRouter!=='1'){
    ...
    if(!managedStructureV3 && toggle && toggle.dataset.pc5152ajToggle!=='1'){
...
(function(){
  ...
  ready(function(){
    ...
    if(window.ProjectCurseStructure?.schema!=='project-curse-structure-v3'){
...
(function(){
  ...
  ready(function(){
    ...
    function getPageId(){
      ...
      return (location.hash||'#terminal-home').slice(1)||'terminal-home';
    }
    ...
    document.addEventListener('pointerdown',function(e){
      ...
      if(isShellTarget(e.target)){
        if(!isDesktop() && e.target.closest && e.target.closest('.side-menu a[data-target]')){
    ...
    function activateSidebarRouteFromEvent(e){
      ...
      const now=Date.now();
      if(now-lastSidebarRouteActivation<650) return false;
      e.preventDefault();
      e.stopPropagation();
      if(e.stopImmediatePropagation) e.stopImmediatePropagation();
      lastSidebarRouteActivation=now;
      routeTo(link.dataset.target||'terminal-home');
      return true;
    }
