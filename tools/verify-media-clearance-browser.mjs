...
check('desktop:data-ledger',dataState.registered===204&&dataState.review===150&&dataState.managed===54,JSON.stringify(dataState));
...
check('desktop:all-assets',await desktop.page.locator('[data-media-path]').count()===204);
await desktop.page.locator('[data-media-kind="image"]').click();
check('desktop:image-filter',await desktop.page.locator('[data-media-path]').count()===174);
...
check('desktop:managed-filter',await desktop.page.locator('[data-media-path]').count()===54);
