...
const desktopShot=join(tmpdir(),'project-curse-5.51.0-media-clearance-desktop.png');
...
const mobileTopShot=join(tmpdir(),'project-curse-5.51.0-media-clearance-mobile-top.png');
...
const mobileShot=join(tmpdir(),'project-curse-5.51.0-media-clearance-mobile.png');
