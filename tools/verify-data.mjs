...
function verify(){
  ...
  add('media-provenance-delivery-lineage',provenanceAssets.filter(asset=>asset.provenance==='DELIVERY_DERIVATIVE').length===204&&provenanceAssets.filter(asset=>asset.provenance==='DELIVERY_DERIVATIVE').every(asset=>asset.derivedFrom&&provenancePaths.includes(asset.derivedFrom)));
  ...
  add('adaptive-media-one-hundred-two-sources',mediaManifest?.version==='1.0.0'&&responsiveAssets.length===102&&responsiveVariants.length===204,`${responsiveAssets.length} sources / ${responsiveVariants.length} variants`);
