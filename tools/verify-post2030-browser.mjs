...
async function openHistory(viewport,label){
  ...
  check(`${label}:build`,await page.evaluate(()=>window.ProjectCurseBuild?.version)==='5.43.1');
...
const desktopShot=join(tmpdir(),'project-curse-5.43.1-aftermath-desktop.png');
...
const mobileShot=join(tmpdir(),'project-curse-5.43.1-aftermath-mobile.png');
