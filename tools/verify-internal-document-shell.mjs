...
check('media:manifest-twenty-four-sources',context.window.ProjectCurseMediaManifest?.version==='1.0.0'&&Object.keys(context.window.ProjectCurseMediaManifest?.assets||{}).length===24);
...
check('media:provenance-all-assets',context.window.ProjectCurseMediaProvenance?.stats?.registered===192&&context.window.ProjectCurseMediaProvenance?.assets?.length===192);
check('media:provenance-honest-review',context.window.ProjectCurseMediaProvenance?.stats?.review===150&&context.window.ProjectCurseMediaProvenance?.stats?.managed===42&&context.window.ProjectCurseMediaProvenance?.stats?.referenceExposure===0);
