...
check('version:manifest',context.window.ProjectCurseStructure?.version==='5.23.2',context.window.ProjectCurseStructure?.version);
check('version:archive',context.window.ProjectCurseArchive?.version==='5.23.2',context.window.ProjectCurseArchive?.version);
check('version:documents',context.window.ProjectCurseArchiveDocuments?.version==='5.23.2',context.window.ProjectCurseArchiveDocuments?.version);
...
check('document:root-loaded',index.includes('assets/css/archive-document.css?v=5.23.2')&&index.includes('assets/js/pages/archive-document.js?v=5.23.2')&&index.includes('assets/js/data/field-dossier-data.js?v=5.23.2'));
...
check('audio:semantic-profile-manifest',audioManifest.includes("version:'2.0.0'")&&audioManifest.includes("'great-black-forest'")&&audioManifest.includes("'dead-zone'")&&audioManifest.includes("'scenario.arm'"));
...
check('operation:root-loaded',index.includes('assets/js/core/operation-state.js?v=5.23.2')&&index.indexOf('assets/js/core/operation-state.js')>index.indexOf('assets/js/core/audio-controller.js')&&index.indexOf('assets/js/core/operation-state.js')<index.indexOf('assets/js/core/record-cinematic-runtime.js'));
const drilldowns=context.window.ProjectCurseRegionalDrilldown?.districts||[];
check('map:drilldown-root-loaded',index.includes('assets/js/data/regional-drilldown-data.js?v=5.23.2')&&index.indexOf('assets/js/data/regional-drilldown-data.js')<index.indexOf('assets/js/data/map-room-data.js'));
...
check('mobile:cinematic-override-loaded-last',index.includes('assets/css/record-cinematic-mobile.css?v=5.23.2')&&index.indexOf('assets/css/record-cinematic-mobile.css')>index.indexOf('assets/css/app-shell.css'));
...
check('immortality:canonical-storyboard-loaded',index.includes('assets/js/data/immortality-storyboard.js?v=5.23.2')&&immortalityPages.length===24,immortalityPages.length);
...
].every(file=>index.includes(`${file}?v=5.23.2`)));
check('cache:cinematic-busters',index.includes('assets/css/record-cinematic.css?v=5.23.2')&&index.includes('assets/js/core/record-cinematic-runtime.js?v=5.23.2'));
check('cache:mobile-cinematic-buster',index.includes('assets/css/record-cinematic-mobile.css?v=5.23.2'));
