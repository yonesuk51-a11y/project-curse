...
check('media:provenance-all-assets',context.window.ProjectCurseMediaProvenance?.stats?.registered===188&&context.window.ProjectCurseMediaProvenance?.assets?.length===188);
check('media:provenance-honest-review',context.window.ProjectCurseMediaProvenance?.stats?.review===150&&context.window.ProjectCurseMediaProvenance?.stats?.managed===38&&context.window.ProjectCurseMediaProvenance?.stats?.referenceExposure===0);
