...
add('personnel-independent-boundary',!personnelData.byId?.frey&&!/프레이|frey/i.test(index+personnelProfileSource+personnelDataSource+personnelRuntime)&&personnelData?.editorialRule?.includes('독립 파일')&&personnelRuntime.includes('56명의 이름·출신·기록 당시 나이'));
