...
add('manifest-runtime-schema-v25',structureData?.schema==='project-curse-v25'&&context.window.ProjectCurseBuild?.schema==='project-curse-v25');
...
add('adaptive-media-root-order',index.includes('assets/css/adaptive-media.css?v=5.34.0')&&index.includes('assets/js/data/media-manifest.js?v=5.34.0')&&index.includes('assets/js/core/adaptive-media.js?v=5.34.0')&&index.indexOf('media-manifest.js')<index.indexOf('adaptive-media.js')&&index.indexOf('adaptive-media.js')<index.indexOf('record-cinematic-runtime.js'));
...
add('quality-policy-root-order',index.includes('assets/css/quality-policy.css?v=5.34.0')&&index.includes('assets/js/core/quality-policy.js?v=5.34.0')&&index.indexOf('performance-telemetry.js')<index.indexOf('quality-policy.js')&&index.indexOf('quality-policy.js')<index.indexOf('adaptive-media.js'));
