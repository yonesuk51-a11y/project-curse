...
add('initial-route-and-detail-safe',index.includes('pc5152ca1-terminal-home active')&&appShell.includes('const initialLocation=readLocation()')&&appShell.includes("commitRoute(initialRoute,initialRoute,initialLocation.personnelId?'none':'replace')"));
