...
const desktopShot=join(tmpdir(),'project-curse-5.47.0-history-map-density-desktop.png');
...
const mobileShot=join(tmpdir(),'project-curse-5.47.0-history-map-density-mobile.png');
