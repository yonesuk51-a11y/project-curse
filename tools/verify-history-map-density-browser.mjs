...
const desktopShot=join(tmpdir(),'project-curse-5.45.0-history-map-density-desktop.png');
...
const mobileShot=join(tmpdir(),'project-curse-5.45.0-history-map-density-mobile.png');
