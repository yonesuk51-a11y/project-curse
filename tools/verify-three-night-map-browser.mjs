...
const desktopShot=join(tmpdir(),'project-curse-5.48.3-synchrony-map-desktop.png');
...
const mobileShot=join(tmpdir(),'project-curse-5.48.3-synchrony-map-mobile.png');
