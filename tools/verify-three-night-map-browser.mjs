...
const desktopShot=join(tmpdir(),'project-curse-5.46.0-synchrony-map-desktop.png');
...
const mobileShot=join(tmpdir(),'project-curse-5.46.0-synchrony-map-mobile.png');
