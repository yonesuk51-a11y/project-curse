# Project Curse Structure — 5.50.0
...
| 초기 인물 명부·소속·관계·능력·기록 한계 | `assets/js/data/personnel-data.js` + `PERSONNEL_SOURCE_NOTES.md` |
