...
- 분위기 기준(2026-09-24 사용자 지정)은 `참고용/Pictures`, `참고용/Pictures2`(사용자의 Project Curse 키 비주얼)와 `참고용/지옥`(FeLLoN 「Curse The Series」)의 그림체·분위기다. 그대로 옮기지 않고 분위기를 파악해 따른다. 인물·구도·문양·장비 디자인은 가져오지 않는다.
  - 명도: 저조도. 화면 대부분이 검정~짙은 회색이고, 형체는 광원 쪽에서만 떠오른다. 가장자리는 어둡게 가라앉는다.
  - 색: 숯빛·청회색·보랏빛 회색 바탕에 포인트 색 하나. 핏빛 적색이 기본이고, 장면에 따라 보랏빛 분홍 조명이나 차가운 흰 손전등 빛을 쓴다. 채도 높은 색을 넓게 칠하지 않는다.
  - 선: 가늘고 거친 잉크 선, 겹쳐 긁은 해칭, 끝이 튀거나 번진 획. 깨끗하고 고른 벡터 선이나 밝은 교재 삽화 마감이 아니다.
  - 질감: 벽·바닥의 피 튄 자국, 흘러내린 자국, 긁힘, 먼지, 약한 종이·필름 그레인.
  - 빛: 이유가 있는 광원 하나(손전등 원뿔, 문틈의 붉은 빛, 스탠드, 불꽃)가 어둠을 조금만 판다. 연무를 깔 수 있다. 빛은 2D로 칠한다. 3D 렌더·CGI 질감(광택 재질, 반사, 피사계심도, 사진 같은 조명)은 쓰지 않는다.
  - 인물: 애니메이션 계열 얼굴에 표정(공포·체념·광기)이 분명하다. 전술 장비는 사실적이고 촘촘하다.
